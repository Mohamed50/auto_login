...
class CustomText extends StatelessWidget {
  ...
  const CustomText(this.text, {Key? key, this.color, this.fontSize, this.fontWeight, this.height, this.letterSpacing, this.fontFamily, this.textAlign, this.maxLines, this.textStyle}) : super(key: key);
